...
CQL3 (see
http://www.khulnasoft.com/dev/blog/thrift-to-cql3[www.khulnasoft.com/dev/blog/thrift-to-cql3]
...
KhulnaSoft Java Driver. Please see the documentation of the Java Driver
