...
public class ProductType
{
    ...
    public enum Product
    {
         ...
         * On-Premises product
         */
        KHULNASOFT_CASSANDRA,

        /**
         * Khulnasoft constellation database-as-a-service product (NOT referring to dse-db, aka. apollo)
         */
        KHULNASOFT_APOLLO
    }
    ...
    {
        Product defaultType = Product.KHULNASOFT_CASSANDRA;
