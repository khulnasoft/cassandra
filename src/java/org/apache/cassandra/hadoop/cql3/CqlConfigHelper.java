...
import com.khulnasoft.driver.core.AuthProvider;
import com.khulnasoft.driver.core.Cluster;
import com.khulnasoft.driver.core.HostDistance;
import com.khulnasoft.driver.core.JdkSSLOptions;
...
import com.khulnasoft.driver.core.ProtocolOptions;
import com.khulnasoft.driver.core.QueryOptions;
import com.khulnasoft.driver.core.SSLOptions;
...
public class CqlConfigHelper
{
    ...
    private static QueryOptions getReadQueryOptions(Configuration conf)
    {
        ...
        if (CL != null && !CL.isEmpty())
            queryOptions.setConsistencyLevel(com.khulnasoft.driver.core.ConsistencyLevel.valueOf(CL));
