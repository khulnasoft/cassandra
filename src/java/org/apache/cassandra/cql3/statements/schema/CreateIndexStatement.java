...
public final class CreateIndexStatement extends AlterSchemaStatement
{
    ...
    public static final Set<String> DSE_INDEXES = ImmutableSet.of(
        "com.khulnasoft.bdp.cassandra.index.solr.SolrSecondaryIndex",
        "com.khulnasoft.bdp.cassandra.index.solr.ThriftSolrSecondaryIndex",
        "com.khulnasoft.bdp.cassandra.index.solr.Cql3SolrSecondaryIndex",
        "com.khulnasoft.bdp.search.solr.ThriftSolrSecondaryIndex",
        "com.khulnasoft.bdp.search.solr.Cql3SolrSecondaryIndex"
    );
